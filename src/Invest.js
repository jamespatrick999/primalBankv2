                ...
                <div className="row">
                    ...
                    <div className="col-xl-4" style={colStyle}>
                        ...
                        >   
                            ...
                            <p style={{ color: "#eee97f", textAlign: "center", fontSize: "15px" }}>USD Approved : {Number(this.props.tokenApproved).toFixed(0) } PRM ({Number(this.props.tokenApproved).toFixed(0)*this.props.prmPrice} USD)</p> 
